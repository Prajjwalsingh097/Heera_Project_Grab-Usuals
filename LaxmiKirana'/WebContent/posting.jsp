...
String mob=request.getParameter("altmob");
...
try
{
    ...
    ResultSet rs=st.executeQuery(a+uid1);
    rs.next();
...
try
{
	...
	PreparedStatement stmt =conn.prepareStatement("INSERT INTO posting values(?,?,?,?,?,?,?,?,?)");
	...
	stmt.setString(7,Ptype);
	stmt.setString(8,email);
	String ss="F:\\";
	FileInputStream fin=new FileInputStream(ss+image);  
	stmt.setBinaryStream(9,fin,fin.available());  
...
{
	i=0;
	System.out.println(" Data Not insertted"+e);
}
 ...
 try
{
    ...
    img_name=img_name.trim();
    	...
    	%>
    	<%
    	out.println(" <br><br>  			 <br> 			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp; <img src="+img_name+"  height="+"140px"+" width="+"200px"+"/>");
    	out.println("<br>");
    	%>
    	<%
    	}
